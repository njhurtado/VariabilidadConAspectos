...
import ejemplo.cajero.properties.AdministradorPropiedades;
import ejemplo.cajero.properties.IPropiedades;
...
public class Cajero {
	...
	private static List<Comando> cargaComandos() {
		...
		if (AdministradorPropiedades.getEntrada(IPropiedades.CONSIGANCIONES)) {
			comandos.add(new ComandoConsignar());
		}
		if (AdministradorPropiedades.getEntrada(IPropiedades.TRANSFERENCIAS)) {
